...
private:
  ...
  std::map<int, void (*)(cpu *)> oplist = {{0, &op0NNN},  {1, &op00E0},  {2, &op00EE},  {3, &op1NNN},  {4, &op2NNN},

                                           {5, &op3XNN},  {6, &op4XNN},  {7, &op5XY0},  {8, &op6XNN},  {9, &op7XNN},

                                           {10, &op8XY0}, {11, &op8XY1}, {12, &op8XY2}, {13, &op8XY3}, {14, &op8XY4},

                                           {15, &op8XY5}, {16, &op8XY6}, {17, &op8XY7}, {18, &op8XYE}, {19, &op9XY0},

                                           {20, &opANNN}, {21, &opBNNN}, {22, &opCXNN}, {23, &opDXYN}, {24, &opEX9E},

                                           {25, &opEXA1}, {26, &opFX07}, {27, &opFX0A}, {28, &opFX15}, {29, &opFX18},

                                           {30, &opFX1E}, {31, &opFX29}, {32, &opFX33}, {33, &opFX55}, {34, &opFX65}};
